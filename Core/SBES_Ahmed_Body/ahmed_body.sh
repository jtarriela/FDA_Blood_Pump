...
#SBATCH --job-name=sbes-ahmd-body
#SBATCH --output=sbes-ahmd-body
...
time fluent 3ddp -g -t${SLURM_NTASKS} -slurm -pib.infinipath -mpi=ibmmpi -cnf=$(pwd)/slurmhosts.$SLURM_JOB_ID.txt -i ahmed_body.jou
