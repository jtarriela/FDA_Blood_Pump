...
time fluent 3ddp -g -t${SLURM_NTASKS} -slurm -pib.infinipath -mpi=ibmmpi -cflush -platform=intel -cnf=$(pwd)/slurmhosts.$SLURM_JOB_ID.txt -i C4_T_IDDES_19M.jou
